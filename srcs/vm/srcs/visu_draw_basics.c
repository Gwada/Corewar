...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/06/13 16:31:41 by fchanal           #+#    #+#             */
/*   Updated: 2018/06/13 16:39:28 by fchanal          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void		normezer(t_core *c)
{
	if (c->visu.stats.win)
		delwin(c->visu.stats.win);
	c->visu.stats.win = newwin(c->visu.stats.size.y, c->visu.stats.size.x, \
			c->visu.title.size.y + c->visu.usages.size.y, 0);
	...
	c->visu.states.win = newwin(c->visu.states.size.y, c->visu.states.size.x, \
			c->visu.title.size.y + c->visu.usages.size.y\
			+ c->visu.stats.size.y, 0);
	...
	c->visu.arena.win = newwin(c->visu.arena.size.y, c->visu.arena.size.x, \
			0, c->visu.w_size.x / 4 + 1);
...
void			draw_basics(t_core *c)
{
	...
	c->visu.title.win = newwin(c->visu.title.size.y,\
			c->visu.title.size.x, 0, 0);
	...
	c->visu.usages.win = newwin(c->visu.usages.size.y, c->visu.usages.size.x,\
			c->visu.title.size.y, 0);
