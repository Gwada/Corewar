...
/*   Updated: 2018/06/13 15:53:57 by dlavaury         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void		display_usage(char *name)
{
	...
	ft_printf(" [[-Debug[start]] champion1.cor]");
	...
	ft_printf("{underline}-Debug[start]{eoc}:");
	ft_printf(" Show RAM and process status with general states");
	ft_printf(", in a graphical interface.\n");
	ft_printf("\tstart: show the RAM after start cycles. ");
	ft_printf("Value is initialized to null by default.\n");
	ft_printf("{underline}-v{eoc}:");
	ft_printf(" Show RAM status in a graphical interface.\n");
	ft_printf("{underline}-n [number]{eoc}: Assign id N to the next champion.");
